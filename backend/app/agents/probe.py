...
from app.profiles import CapabilityEvidence, StoredProfile
...
async def _probe_structured(
    *,
    ...
    async with binding:
        ...
        _assert_usage_reported(result.usage.requests, result.usage.input_tokens, result.usage.output_tokens)
    ...
    *,
    ...
    async with binding:
        ...
        async with agent.run_stream(
            "Return only the text NOVELPILOT_CAPABILITY_OK."
        ) as streamed:

...
from app.agents.contracts import ProfileSnapshot
from app.agents.probe import PROBE_MARKER, probe_stored_profile
from app.agents.probe import ProfileCapabilityProbeError
from app.agents.transport import ActivationRequestBudget, RequestCountingModel
from app.profiles import StoredProfile
...
class SecretEchoingResolver:
    def resolve(self, **_kwargs: object) -> ResolvedModelBinding:
        raise RuntimeError(
            ...
            "https://provider.example?signature=probe-secret"
        )
